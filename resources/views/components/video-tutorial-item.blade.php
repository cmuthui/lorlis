                ...
                <div class="w-full h-full absolute top-0 left-0 p-3">
                    ...
                    <div class="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-primary bg-opacity-0 z-10">
                        ...
                        <a 
                            ...
                            class="flex items-center w-20 md:w-[70px] h-20 md:h-[70px] rounded-full bg-white text-primary absolute z-20"
                            >
                            <span 
                                class="absolute w-full h-full rounded-full top-0 right-0 bg-white bg-opacity-20 z-[-1] animate-ping delay-300 duration-10"
                            ></span>
                            <!-- Play Icon-->
                            <svg
                                width="23"
